...
public class OfferRuleItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OffersPackage.Literals.OFFER_RULE__RULE_TRIGGER);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(OffersPackage.Literals.OFFER_RULE__ACTIONS,
				 OffersFactory.eINSTANCE.createFlatDiscount()));

		newChildDescriptors.add
			(createChildParameter
				(OffersPackage.Literals.OFFER_RULE__ACTIONS,
				 OffersFactory.eINSTANCE.createPercentageDiscount()));

		newChildDescriptors.add
			(createChildParameter
				(OffersPackage.Literals.OFFER_RULE__ACTIONS,
				 OffersFactory.eINSTANCE.createSetPrice()));
		...
		newChildDescriptors.add
			(createChildParameter
				(OffersPackage.Literals.OFFER_RULE__CONDITIONS,
				 OffersFactory.eINSTANCE.createRequiresTarget()));

		newChildDescriptors.add
			(createChildParameter
				(OffersPackage.Literals.OFFER_RULE__CONDITIONS,
				 OffersFactory.eINSTANCE.createOrderTotal()));

		newChildDescriptors.add
			(createChildParameter
				(OffersPackage.Literals.OFFER_RULE__CONDITIONS,
				 OffersFactory.eINSTANCE.createOnDate()));

		newChildDescriptors.add
			(createChildParameter
				(OffersPackage.Literals.OFFER_RULE__RULE_TRIGGER,
				 OffersFactory.eINSTANCE.createRuleTrigger()));
	}
