	...
	protected void addRepeatablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_repeatable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_repeatable_feature", "_UI_Action_type"),
				 OffersPackage.Literals.ACTION__REPEATABLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
